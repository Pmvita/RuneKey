        ...
        <View className="px-6">
          ...
          <Card variant="outlined" className="p-6 mb-6">
            <View className="items-center mb-6">
              <View className="w-20 h-20 bg-glass-white dark:bg-glass-dark border-2 border-glass-frost dark:border-ice-700/50 rounded-full items-center justify-center mb-4 shadow-lg">
                <Image
          ...
          <Card variant="outlined" className="p-4 mb-6 border-green-200 dark:border-green-800">
            <Text className="text-lg font-bold text-green-800 dark:text-green-200 mb-3">
